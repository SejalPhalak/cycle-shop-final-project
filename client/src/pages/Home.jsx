    ...
    <main className="bg-[var(--color-bg)] text-[var(--color-text)]">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            {featuredCycles.map((cycle) => (
              ...
              >
                ...
                {/* Image Placeholder */}
                <div className="flex h-60 items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <section className="bg-[var(--color-bg)] py-16 sm:py-20">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 sm:px-8 md:grid-cols-2">
          ...
          <div className="flex min-h-[360px] items-center justify-center overflow-hidden rounded-[2rem] bg-[var(--color-dark-blue)] shadow-2xl">
